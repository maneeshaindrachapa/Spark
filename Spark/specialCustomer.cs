...
namespace Spark
{
    public partial class specialCustomer : Form
    {
        ...
        //change model name according to the change of brandname
            ...
            try
            {
                ...
                if (dtbl.Rows.Count > 0)
                {
                    foreach (DataRow row in dtbl.Rows)
                    {
                        ...
                        discountlbl.Text = "Discount Rate(%)";
                        if (row["discountRate"] != null)
                        {
                            discountTxt.Text = row["discountRate"].ToString();
                        }
                        else
                        {
